        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/cargo/invoice/edit.do" method="post">
                <div class="row data-type" style="margin: 0px">
                    <div class="col-md-2 title">票号</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="委托单单号" name="invoiceId"
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="承运公司" name="transcompanyName"
                               value="${invoice.transcompanyName}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="总价" name="totalPrices"
                               value="${invoice.totalPrices}" readonly>
                    </div>


                    <div class="col-md-2 title">实收</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="实收" name="gathering"
                               value="${invoice.gathering}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        ...
                        <input type="text" class="form-control" placeholder="委托单号" name="shippingId"
                               value="${invoice.shippingId}" readonly>
                    </div>
                    <%--
