            ...
            <form id="editForm" action="${ctx}/cargo/packing/edit.do" method="post">
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="卖家" name="seller"
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="创建人" name="createBy"
                               value="${packing.createBy}">
                    </div>
                    <div class="col-md-2 title">创建组织</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="创建组织" name="createDept"
                               value="${packing.createDept}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" placeholder="创建时间" name="createTime" class="form-control pull-right"
                                   value="<fmt:formatDate value="${packing.createTime}" pattern="yyyy-MM-dd"/>"
                                   id="shipTime">
                        </div>
                    </div>
                    <br/>
                    ...
                    <div class="col-md-10 data ">
                        <textarea class="form-control" rows="1" name="exportIds"
                                  readonly>${packing.exportIds}</textarea>
                    </div>
                    <br/>
                    <div class="col-md-2 title rowHeight2x">备注</div>
                    <div class="col-md-10 data rowHeight2x">
                        <textarea class="form-control" rows="3" name="descriptions">${packing.descriptions}</textarea>
                    </div>
                    <%--
